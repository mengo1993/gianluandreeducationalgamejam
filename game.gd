...
const MAX_HUE_VARIATION : float = 1  # Maximum hue variation (e.g., a full 360-degree shift)
...
func _on_slider_lifetime_mouse_entered() -> void:
...
func _on_slider_amount_mouse_entered() -> void:
...
func _on_slider_color_mouse_entered() -> void:
...
func _on_slider_radial_speed_mouse_entered() -> void:
...
func _on_slider_lifetime_mouse_exited() -> void:
	modulate.a = 1.0
	var tween = create_tween()
	tween.tween_property(pamplets, "modulate:a", 0.0,0.1)
	tween.set_ease(Tween.EASE_OUT)
	tween.set_trans(Tween.TRANS_QUAD)


func _on_slider_amount_mouse_exited() -> void:
	modulate.a = 1.0
	var tween = create_tween()
	tween.tween_property(pamplets, "modulate:a", 0.0,0.1)
	tween.set_ease(Tween.EASE_OUT)
...
func _on_slider_color_mouse_exited() -> void:
	modulate.a = 1.0
	var tween = create_tween()
	tween.tween_property(pamplets, "modulate:a", 0.0,0.1)
	tween.set_ease(Tween.EASE_OUT)
...
func _on_slider_radial_speed_mouse_exited() -> void:
	modulate.a = 1.0
	var tween = create_tween()
	tween.tween_property(pamplets, "modulate:a", 0.0,0.1)
	tween.set_ease(Tween.EASE_OUT)
